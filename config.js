...
module.exports = {
    SESSION_ID: process.env.SESSION_ID || "DARK-SILENCE-MD~icgiCRSI#pyieKWqZOgeXNEIaKeaDBdK1Dn95WeiuYijjSaVryPI",
    CAPTION: process.env.CAPTION || "POWERED BY SILENTLOVER511",
    ...
    ALIVE_IMG: process.env.ALIVE_IMG || "https://files.catbox.moe/n5sgu5.jpg",
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || "923477756511",
    OWNER_NAME: process.env.OWNER_NAME || "➺ѕเℓεɳƭ_ℓσѵε૨࿐",
    READ_CMD: process.env.READ_CMD || "true",
    BOT_NAME: process.env.BOT_NAME || "➺〆 Z 么 I N 〆 bot",
